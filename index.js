...
const quiz = await inquirer.prompt([
    ...
    },
    {
        name: "question_3",
        type: "list",
        message: "Q3 Wich operator is commonly used used for string concatenaartion in Typescript",
        choices: ["+", "-", "*", "/"]
    },
    {
        name: "question_4",
    ...
    },
    {
        name: "question_5",
        type: "list",
        message: "Q5.Wich method of inquirer.js is used to start the prompt interface and receive userinput",
